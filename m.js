...
!(function (t, e) {
    ...
    for (e = 0; e < v; e++)
      if (
        ...
        (c = m),
          (g = w),
          ("C" !== p && "S" !== p) ||
            ((c += m - s[s.length - 4]), (g += w - s[s.length - 3])),
          a || (m = w = 0),
        ...
        "Z" === i && ((r = h), (o = l), (s.closed = !0)),
          ("L" === i || 0.5 < k(m - r) || 0.5 < k(w - o)) &&
            (yc(m, w, r, o), "L" === i && (e += 2)),
          (m = r),
          (w = o);
      else if ("A" === i) {
    ...
    for (
      ...
      for (n = (a = t[m]).length, i = 6; i < n; i += 6)
        for (
          ...
          w <
          (r =
            ((h = M * s) * h * u + 3 * (l = 1 - h) * (h * p + l * f)) * h + c)
            ? (w = r)
            : r < v && (v = r),
            y < (o = (h * h * _ + 3 * l * (h * P + l * d)) * h + g)
              ? (y = o)
              : o < x && (x = o);
    return (
      (t.centerX = (w + v) / 2),
  ...
  function Z(t, e, n) {
    var r,
      ...
      f = 0;
    for (i = 6; i < a; i += 6)
      (o = Y(t, e, i / 6, l, c)) < g && ((g = o), (f = i));
    if (n)
      for (reverseSegment((r = t.slice(0))), i = 6; i < a; i += 6)
        (o = Y(r, e, i / 6, l, c)) < g && ((g = o), (f = -i));
    return f / 6;
  }
  function $(t, e, n) {
    for (var r, o, i, a, s, h, l = t.length, c = 1e20, g = 0, f = 0; -1 < --l; )
      for (h = (r = t[l]).length, s = 0; s < h; s += 6)
        (o = r[s] - e),
          (i = r[s + 1] - n),
          (a = w(o * o + i * i)) < c && ((c = a), (g = r[s]), (f = r[s + 1]));
    return [g, f];
  }
            ...
            (Math.abs(a[0] - a[a.length - 2]) < 0.5 &&
              ...
              ? "auto" === n || "log" === n
                ? ((v[w] = n = Z(a, i, !w || !1 === o)),
                  ...
                  X(a, 6 * n))
                : "reverse" !== n &&
                  (w && n < 0 && reverseSegment(a), X(a, 6 * (n < 0 ? -n : n)))
              : !y &&
                (("auto" === n &&
                  Math.abs(i[0] - a[0]) +
                    Math.abs(i[1] - a[1]) +
  ...
  function ia(t, e) {
    for (
      var n, r, o, i, a, s, h, l, c, g, f, p, u = t.length, d = 0.2 * (e || 1);
      -1 < --u;
  ...
  function na(t) {
    (o = y()),
      ...
      o && n
        ? ((j = o.utils.toArray), (n.prototype._tweenRotation = ma), (F = 1))
  ...
  var o,
    ...
    H = (function (t) {
      ...
      return e || !setTimeout(function () {}, 3e3);
    ...
    K = {
      ...
      init: function init(t, e, n, r, o) {
        ...
        if (
          ...
          return M("Cannot morph a <" + i + "> element. " + J), !1;
        if (
        ...
        if (
          ...
          return M("A <" + i + "> cannot accept path data. " + J), !1;
        if (
          ...
          S &&
            ...
            s && (this._props.push("morphSVG"), (s.end = h), (s.endProp = a));
        }
        return H;
      },
